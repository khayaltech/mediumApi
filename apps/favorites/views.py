...
from apps.articles.serializers import ArticleCreateSerializer
...
addToFavoritesView = FavoriteAPIView.as_view()
userFavoritesView = ListUserFavoriteArticlesAPIView.as_view()
