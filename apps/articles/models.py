...
from .read_time import ReadTimeEngine
...
class Article(TimeStampedUUIDModel):
    author = models.ForeignKey(
        User, verbose_name=_("user"), on_delete=models.CASCADE, related_name="articles"
    )
    ...
    banner_image = models.ImageField(
        verbose_name=_("banner image"), default="/banner.png"
    )
    ...
    def article_read_time(self):
        time_to_read = ReadTimeEngine(self)
